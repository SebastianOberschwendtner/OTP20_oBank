...
namespace GUI
{
    ...
    struct State_ID
    {
        enum 
        {
            Main_Info, Status_Info, Cell_Info, SOC_Info, Time_Info, PD_Info
        };
    };
    ...
    constexpr state StateTable[] =
    {
        ...
        state(State_ID::PD_Info    , nullptr                 , nullptr          )
    };
...
transition(State_ID::Time_Info  , Event_ID::Next_Page     , State_ID::PD_Info    , &Actions::Clear_Buffer     , nullptr),
